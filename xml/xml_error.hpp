...
///////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef XML_ERROR_HPP
#define XML_ERROR_HPP
...
public:
    ...
    std::string message(int ev) const override { return ev == static_cast<int>(errc::user_error) ? std::string() : XML_ErrorString(XML_Error(ev)); }
};
...
{
    template<>
    struct is_error_code_enum<xml::errc>: public true_type { };
}
